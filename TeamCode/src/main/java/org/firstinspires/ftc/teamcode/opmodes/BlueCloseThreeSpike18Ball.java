...
public class BlueCloseThreeSpike18Ball extends BaseAuto {
    @Override
    ...
    protected void setActionList() {
        ...
        PathChain path2ndSpike = follower.pathBuilder()
                ...
                .setLinearHeadingInterpolation(Math.toRadians(130), Math.toRadians(180), .4)
                .build();
        ...
        PathChain Gate = follower.pathBuilder()
                ...
                .setLinearHeadingInterpolation(Math.toRadians(228), Math.toRadians(150), .6)
                .build();
        ...
        PathChain ThirdSpikeMark = follower.pathBuilder()
                .addPath(
                        new BezierCurve(
                                shootingPose,
                                new Pose(82, 26).mirror(),
                                new Pose(128, 35).mirror()
                        )
                )
